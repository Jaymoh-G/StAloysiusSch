...
<head>
	...
	<link href="{{ asset('adminassets/vendor/owl-carousel/owl.carousel.css') }}">
	<link rel="stylesheet" href="{{ asset('adminassets/vendor/nouislider/nouislider.min.css') }}">
...
<script src="{{ asset('adminassets/vendor/jquery-nice-select/js/jquery.nice-select.min.js') }}"></script>
	...
	<!-- Apex Chart -->
<script src="{{ asset('adminassets/vendor/apexchart/apexchart.js') }}"></script>
<script src="{{ asset('adminassets/vendor/chart.js/Chart.bundle.min.js') }}"></script>
